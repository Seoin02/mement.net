    ...
    <main className="w-full h-full bg-white py-8">
      ...
      <section className="w-[75%] mx-auto py-14 mobile:w-[85%]">
        <form id="askBranchForm" method="POST" onSubmit={handleSubmit} data-email="support@mement.net" className="gform" action={import.meta.env.VITE_GOOGLE_FORM_API_KEY}>
            <div className="w-full flex flex-row justify-between gap-20 mobile:flex-col mobile:gap-8 tablet:gap-12">
            <div className="flex flex-col gap-8 w-1/2 mobile:w-full">
            <label className="tablet:text-[16px] text-left text-[18px] font-bold flex flex-row mobile:flex-col mobile:w-full mobile:items-start justify-between gap-4 items-center">{t("AskBranchPage.name")}
            ...
            <label className="tablet:text-[16px] text-left text-[18px] font-bold flex flex-row mobile:flex-col mobile:w-full mobile:items-start justify-between gap-4 items-center">{t("AskBranchPage.age")}
            ...
            <label className="tablet:text-[16px] text-left text-[18px] font-bold flex flex-row mobile:flex-col mobile:w-full mobile:items-start justify-between gap-4 items-center">{t("AskBranchPage.phoneNumber")}
            ...
            <label className="tabletPro:whitespace-nowrap tablet:text-[16px] tablet:whitespace-nowrap text-left text-[18px] font-bold flex flex-row mobile:flex-col mobile:w-full mobile:items-start justify-between gap-4 items-center">{t("AskBranchPage.prefferedLocation")}
            ...
            <label className="tablet:text-[16px] tablet:whitespace-nowrap text-left text-[18px] font-bold flex flex-row justify-between">
            ...
            <label className="tablet:text-[16px] tablet:whitespace-nowrap text-left text-[18px] font-bold flex flex-row mobile:flex-col mobile:w-full mobile:items-start justify-between gap-4 items-center pointer-cursor">
            ...
            <label className="tablet:text-[16px] tablet:whitespace-nowrap tabletPro:whitespace-nowrap mobile:whitespace-nowrap text-left text-[18px] font-bold flex flex-row mobile:flex-col mobile:w-full mobile:items-start justify-between gap-4 items-center pointer-cursor ">
            ...
            <label className="tablet:text-[16px] tablet:whitespace-nowrap text-left text-[18px] font-bold flex flex-row mobile:flex-col mobile:w-full mobile:items-start items-start mt-8 justify-between mobile:flex-col tablet:gap-4">
        ...
        <button form="askBranchForm" type="submit" className="mobile:w-full px-[80px] py-[13px] mt-[29px] mx-auto bg-[#00A7FF] hover:bg-white hover:text-[#00A7FF] border-2 border-[#00A7FF] hover:border-[#00A7FF] rounded-sm text-white font-[18px] font-bold cursor-pointer tablet:mt-20 tabletPro:mt-20">{t("AskBranchPage.Send")}</button>
        </section>
