...
export default function CommunityPage() {
  ...
  return (
    ...
    <a href="/ask-branch" className="w-[75%] mx-auto text-black py-[35px] flex justify-between items-center px-8 border-b-2 border-t-2 border-gray-100 text-[23px] hover:text-[#00A7FF] hover:shadow-md"><p>{t("CommunityPage.AskBranch")}</p><p>ᐳ</p></a>
    </main>
  )
}