...
export default function Footer(): JSX.Element {
  return <footer className="flex flex-row justify-between items-center mx-auto w-[75%] mobile:ml-8">
    ...
    <ul className="text-[#5C5C5C] text-right text-[14px] mobile:text-left mobile:text-[12px]">
          <li className="pt-8 mobile:pt-4">9F, 509, Teheran-ro, Gangnam-gu, Seoul, Republic of Korea<br/>
