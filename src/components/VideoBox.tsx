...
export default function VideoBox({videoLink, firstTitle, secondTitle}: IVideoBoxProps) {
  return (
    <section className="relative bg-gray-500 h-[960px] flex items-center">
        ...
        <div className="overflow-hidden w-[718px] h-[162px] flex flex-col justify-center items-left z-10 object-cover ml-[160px]">
            <p className="text-white text-left text-[64px] font-medium animate-fade-in">
